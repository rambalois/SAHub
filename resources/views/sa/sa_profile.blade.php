                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="{{$taskHistory->time_in}}">{{$taskHistory->time_in}}</td>
                                <td data-label="{{$taskHistory->time_out}}">{{$taskHistory->time_out}}</td>
                                <td data-label="Hours">{{$taskHistory->total_hours}}</td>
